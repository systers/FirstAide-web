...
<div class="window">
  ...
  <div id="popup-cnt" class="popup">
    <div class="popup-content">
      ...
      <button id="call" class="popup-button" onclick="make_call('+14088444357')">Voice Call&nbsp;&nbsp;&nbsp;&nbsp;<i class="w3-margin-left fa fa-phone"></i></button>
      <button id="msg" class="popup-button" onclick="send_sms('+14088444357')">Send Message&nbsp;&nbsp;&nbsp;<i class="w3-margin-left fa fa-envelope"></i></button>
    </div>
  </div>
